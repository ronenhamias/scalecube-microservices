...
public class TestRedisStore extends TestCase {
  ...
  public void testRedisOrganizationMembers() throws AccessPermissionException{
    ...
    User member1 = new User("id1", "email0", true, "name0", "pictureUrl0", "locale0", "familyName0", "givenName0",null);
    organizations.invite(owner, org, member1);
    organizations.invite(owner, org, new User("id2", "email2", true, "name2", "pictureUrl2", "locale2", "familyName2", "givenName2",null));
    System.out.println(organizations.getOrganizationMembers(org.id())); 
    
    organizations.leave(org, new User("id2", "email2", true, "name2", "pictureUrl2", "locale2", "familyName2", "givenName2",null));
    System.out.println(organizations.getOrganizationMembers(org.id())); 
